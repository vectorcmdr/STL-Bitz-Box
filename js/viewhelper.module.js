...
class ViewHelper extends Object3D {
	...
	constructor(camera, domElement) {
		...
		const color1 = new Color('#ff2d5e'); // senzai hydrangea dark
		const color2 = new Color('#9bd85a'); // senzai gingko dark
		const color3 = new Color('#49d1e9'); // senzai sky dark
		const color4 = new Color('#111114'); // senzai slate
